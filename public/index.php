...
<head>
	<!-- Title -->
	<title>Ross Edlin | Projects</title>
					...
					<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
						<ul id="js-scroll-nav"
							...
							<li class="nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
								<a href="https://www.rossedlin.com/contact/" target="_blank" class="nav-link p-0">Contact</a>
							</li>
						</ul>
					</div>
					<!-- End Navigation -->
			...
			<div class="row">
				...
				<div class="col-md-4 align-self-center">
					<ul class="list-inline text-center text-md-right mb-0">
						...
						<li class="list-inline-item g-mx-10" data-toggle="tooltip" data-placement="top"
							title="Instagram">
							<a href="https://www.instagram.com/rossedlin/" target="_blank"
							   class="g-color-white-opacity-0_5 g-color-white--hover">
						...
						<li class="list-inline-item g-mx-10" data-toggle="tooltip" data-placement="top"
							title="Twitter">
							<a href="https://twitter.com/rossedlin" target="_blank"
							   class="g-color-white-opacity-0_5 g-color-white--hover">
